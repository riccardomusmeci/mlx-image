...
def regnet_x_800mf(num_classes=1000, **kwargs) -> RegNet:
...
def regnet_x_1_6gf(num_classes=1000, **kwargs) -> RegNet:
    block_params = BlockParams.from_init_params(depth=18, w_0=80, w_a=34.01, w_m=2.25, group_width=24, **kwargs)
    return RegNet(
        block_params=block_params, norm_layer=partial(nn.BatchNorm, eps=1e-05, momentum=0.1), num_classes=num_classes
    )


def regnet_x_3_2gf(num_classes=1000, **kwargs) -> RegNet:
    block_params = BlockParams.from_init_params(depth=25, w_0=88, w_a=26.31, w_m=2.25, group_width=48, **kwargs)
    return RegNet(
        block_params=block_params, norm_layer=partial(nn.BatchNorm, eps=1e-05, momentum=0.1), num_classes=num_classes
    )


def regnet_x_8gf(num_classes=1000, **kwargs) -> RegNet:
    block_params = BlockParams.from_init_params(depth=23, w_0=80, w_a=49.56, w_m=2.88, group_width=120, **kwargs)
    return RegNet(
        block_params=block_params, norm_layer=partial(nn.BatchNorm, eps=1e-05, momentum=0.1), num_classes=num_classes
    )


def regnet_x_16gf(num_classes=1000, **kwargs) -> RegNet:
    block_params = BlockParams.from_init_params(depth=22, w_0=216, w_a=55.59, w_m=2.1, group_width=128, **kwargs)
    return RegNet(
        block_params=block_params, norm_layer=partial(nn.BatchNorm, eps=1e-05, momentum=0.1), num_classes=num_classes
    )


def regnet_x_32gf(num_classes=1000, **kwargs) -> RegNet:
    block_params = BlockParams.from_init_params(depth=23, w_0=320, w_a=69.86, w_m=2.0, group_width=168, **kwargs)
    return RegNet(
        block_params=block_params, norm_layer=partial(nn.BatchNorm, eps=1e-05, momentum=0.1), num_classes=num_classes
    )
