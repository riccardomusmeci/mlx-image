...
swin_configs = {
    ...
    "swin_v2_tiny_patch4_window8_224": ModelConfig(
        ...
        weights=HFWeights(repo_id="mlx-vision/swin_v2_tiny_patch4_window8_224-mlxim", filename="model.safetensors"),
    ),
    "swin_v2_small_patch4_window8_224": ModelConfig(
        metrics=Metrics(dataset="ImageNet-1K", accuracy_at_1=0.81614, accuracy_at_5=0.95515),
        transform=Transform(img_size=256, crop_pct=256 / 260, interpolation="bicubic"),
        weights=HFWeights(repo_id="mlx-vision/swin_s2_small_patch4_window8_224-mlxim", filename="model.safetensors"),
    ),
    "swin_v2_base_patch4_window8_224": ModelConfig(
        ...
        weights=HFWeights(repo_id="mlx-vision/swin_v2_base_patch4_window8_224-mlxim", filename="model.safetensors"),
    ),
}
...
def swin_v2_tiny_patch4_window8_224(num_classes: int = 1000) -> SwinTransformer:
    return SwinTransformer(
        patch_size=[4, 4],
        embed_dim=96,
        depths=[2, 2, 6, 2],
...
def swin_v2_base_patch4_window8_224(num_classes: int = 1000) -> SwinTransformer:
    return SwinTransformer(
        patch_size=[4, 4],
        embed_dim=128,
        depths=[2, 2, 18, 2],
...
def swin_v2_small_patch4_window8_224(num_classes: int = 1000) -> SwinTransformer:
    return SwinTransformer(
        patch_size=[4, 4],
        embed_dim=96,
        depths=[2, 2, 18, 2],
